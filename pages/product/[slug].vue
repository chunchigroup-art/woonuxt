        ...
        <div class="w-full lg:max-w-md xl:max-w-lg md:py-2">
          ...
          <form @submit.prevent="handleAddToCart">
            ...
            <a
              ...
              target="_blank"
              class="rounded-lg flex font-bold bg-gray-800 text-white text-center min-w-37.5 p-2.5 gap-4 items-center justify-center focus:outline-none hover:bg-gray-700">
